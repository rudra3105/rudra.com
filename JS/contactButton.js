...
firstPlatform.addEventListener('click',()=>{
    window.open("https://twitter.com/rudra_bhatt_31");
});
secondPlatform.addEventListener('click',()=>{
    window.open("mailto:rudrabhatt525@gmail.com");
});
thirdPlatform.addEventListener('click',()=>{
    window.open("https://github.com/rudra3105");
});
fourthPlatform.addEventListener('click',()=>{
    window.open("https://www.linkedin.com/in/rudra-bhatt-763457239/");
});